package utilities.Engine.Combat{
	...
	public class EnemyManager extends utilities.Engine.DefaultManager{
		...
		public static function createNewEnemy(){
			var enemy = new Enemy();
			enemies.push(enemy);
		...
		public static function checkForCollisionWithBullets(){
			for each(var enemy:Enemy in enemies){
				...
				for each(var bullet:Bullet in BulletManager.bullets){
					//if(enemy.getQuadTreeNode() == bullet.getQuadTreeNode()){
						...
						var minDist = (bullet.width/2 + enemy.width/2) * (bullet.width/2 + enemy.width/2);
		...
		public function getObjectAtIndex(index):Object{
